...
plt.ylabel('Unidades', fontsize=12, fontweight='bold')
plt.title("Reporte de Producción")
plt.xticks(rotation=45)

plt.savefig("data/reporte_impresion.png", format='png', dpi=300, bbox_inches='tight')
plt.savefig("data/reporte_web.svg", format='svg', bbox_inches='tight')
plt.savefig("data/reporte_ejecutivo.pdf", format='pdf', bbox_inches='tight')
plt.show()
